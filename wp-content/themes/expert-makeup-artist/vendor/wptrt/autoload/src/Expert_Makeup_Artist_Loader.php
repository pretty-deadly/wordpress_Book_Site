...
class Expert_Makeup_Artist_Loader {
	/**
	 * Array of loaders.
	 *
	 * @since  1.0.0
	 ...
	 * @return void
	 */
	public function expert_makeup_artist_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function expert_makeup_artist_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function expert_makeup_artist_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function expert_makeup_artist_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->expert_makeup_artist_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function expert_makeup_artist_load( $class ) {
